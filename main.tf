locals {
  ...
  iam_instance_profile_name =  var.create_iam_instance_profile && var.iam_instance_profile_name == null ? try(aws_iam_instance_profile.this[0].name, "") : var.iam_instance_profile_name
