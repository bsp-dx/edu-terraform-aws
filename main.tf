...
locals {
  ...
  service_linked_role_arn = var.create_service_linked_role && var.service_linked_role_arn == null ? try(aws_iam_service_linked_role.autoscaling[0].arn, "") : var.service_linked_role_arn
}
