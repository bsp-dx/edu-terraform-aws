...
variable "name" {
  description = "Instance name used across the resources created"
  type        = string
}
...
variable "create_service_linked_role" {
  description = "Whether to create `autoscaling.amazonaws.com` service-linked role for AutoScaling "
  type = bool
  default = false
}
